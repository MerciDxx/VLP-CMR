...
class CLIP(nn.Module):
    def __init__(self,args):
        ...
        elif args.datasets=="GraspNet":
            class_list = ['a 3D point cloud image of a banana', 'a 3D point cloud image of a box', 'a 3D point cloud image of a can', 'a 3D point cloud image of a camel', 'a 3D point cloud image of a dish', 'a 3D point cloud image of a drill', 'a 3D point cloud image of a mouse', 'a 3D point cloud image of a pear', 'a 3D point cloud image of a scissors', 'a 3D point cloud image of a shampoo']
        elif args.datasets=="PointDA":
            class_list = ['a 3D point cloud image of a bathtub', 'a 3D point cloud image of a bed', 'a 3D point cloud image of a bookshelf', 'a 3D point cloud image of a cabinet', 'a 3D point cloud image of a chair', 'a 3D point cloud image of a lamp', 'a 3D point cloud image of a monitor', 'a 3D point cloud image of a plant', 'a 3D point cloud image of a sofa', 'a 3D point cloud image of a table']
